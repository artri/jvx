 ...
 * </p>
 * <p>
 * <img class="gallery" src="doc-files/PopupPanel.png" alt="">
 * </p>
 *
 * <p>
 ...
 * 
 * <h3>Example</h3>
 * <a href="com.google.gwt.examples.PopupPanelExample">PopupPanelExample</a>
 * 
...
//  }-*/;    
  ...
  public void center() {
    ...
    int width = getPixelValue(getElement().getStyle().getWidth());
    int height = getPixelValue(getElement().getStyle().getHeight());
    if (width <= 0)
    {
