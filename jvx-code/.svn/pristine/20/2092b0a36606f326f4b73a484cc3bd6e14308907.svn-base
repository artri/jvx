...
[NEW]
  ...
  - #199: Set the automatic link editor invisible for MasterReference
  - #207: use compression option for SubConnection from MasterConnection
  ...
  - #290: DataBook in DATASOURCE level shouldn't fetch details to master 
          that is currently inserting
  - #294: Guarantee 1 data row read ahead, to support loops with getRowCount  
...
[NEW]
  ...
  - #242: don't throw Exceptions for already declared default choice editors
