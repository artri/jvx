...
/**
 * The <code>LessEquals</code> condition implements the comparison "&lt;=" (less equals) of values.
 * 
 * @author Roland Hörmann
 */
public class LessEquals extends CompareCondition
{
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	// Initialization
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	/**
	 * Creates a new instance of <code>LessEquals</code>.
	 */
	public LessEquals() 
    {
    }
	...
	/**
	 * Creates a new instance of <code>LessEquals</code> with a defined compare value.
	 * 
	 * @param pColumnName the column name for the value comparison
	 * @param pValue the value to compare 
	 */
	public LessEquals(String pColumnName, Object pValue) 
    {
    	super(pColumnName, pValue);
    }
    
	/**
	 * Creates a new instance of <code>LessEquals</code> with a defined compare value. It's
	 ...
	 */
    public LessEquals(String pColumnName, Object pValue, boolean pIgnoreNull) 
    {
    	super(pColumnName, pValue, pIgnoreNull);
    }
    
    /**
     * Constructs a new LessEquals Condition, with a column, the IDataRow to check
     ...
     */
    public LessEquals(IDataRow pDataRow, String pColumnName)
    {
     ...
     */
    public LessEquals(IDataRow pDataRow, String pColumnName, boolean pIgnoreNull)
    {
     ...
     * 			the column name to use for the compare operation
     */
    public LessEquals(IDataRow pDataRow, String pDataRowColumnName, String pColumnName)
    {
     ...
     * 			determines if null values should be ignored.
     */
    public LessEquals(IDataRow pDataRow, String pDataRowColumnName, String pColumnName, boolean pIgnoreNull)
    {
