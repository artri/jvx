...
/**
 * The generic implementation of {@link IMouseExitedListener}.
 * 
 * @author René Jahn
 */
public class IMouseExitedListenerProxy extends AbstractListenerProxy
                                       implements IMouseExitedListener
{
	...
	/**
	 * Creates a new instance of <code>IMouseExitedListenerProxy</code>.
	 * 
	 * @param pHandler the handler
	 */
	public IMouseExitedListenerProxy(InvocationHandler pHandler)
	{
		super(pHandler);
	}
