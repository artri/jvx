...
/**
 * The generic implementation of {@link IMouseEnteredListener}.
 * 
 * @author René Jahn
 */
public class IMouseEnteredListenerProxy extends AbstractListenerProxy
                                        implements IMouseEnteredListener
{
	...
	/**
	 * Creates a new instance of <code>IMouseEnteredListenerProxy</code>.
	 * 
	 * @param pHandler the handler
	 */
	public IMouseEnteredListenerProxy(InvocationHandler pHandler)
	{
		super(pHandler);
	}
