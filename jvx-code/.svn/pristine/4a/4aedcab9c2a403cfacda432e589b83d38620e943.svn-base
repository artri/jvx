...
/**
 * The <code>Less</code> condition implements the comparison "&lt;" (less) of values.
 * 
 * @author Roland Hörmann
 */
public class Less extends CompareCondition
{
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	// Initialization
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	/**
	 * Creates a new instance of <code>Less</code>.
	 */
	public Less() 
    {
    }
	...
	/**
	 * Creates a new instance of <code>Less</code> with a defined compare value.
	 * 
	 * @param pColumnName the column name for the value comparison
	 * @param pValue the value to compare 
	 */
	public Less(String pColumnName, Object pValue) 
    {
    	super(pColumnName, pValue);
    }
    
	/**
	 * Creates a new instance of <code>Less</code> with a defined compare value. It's
	 ...
	 */
    public Less(String pColumnName, Object pValue, boolean pIgnoreNull) 
    {
    	super(pColumnName, pValue, pIgnoreNull);
    }
    
    /**
     * Constructs a new Less Condition, with a column, the IDataRow to check
     ...
     */
    public Less(IDataRow pDataRow, String pColumnName)
    {
     ...
     */
    public Less(IDataRow pDataRow, String pColumnName, boolean pIgnoreNull)
    {
     ...
     * 			the column name to use for the compare operation
     */
    public Less(IDataRow pDataRow, String pDataRowColumnName, String pColumnName)
    {
     ...
     * 			determines if null values should be ignored.
     */
    public Less(IDataRow pDataRow, String pDataRowColumnName, String pColumnName, boolean pIgnoreNull)
    {
