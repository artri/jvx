...
/**
 * The generic implementation of {@link IKeyReleasedListener}.
 * 
 * @author René Jahn
 */
public class IKeyReleasedListenerProxy extends AbstractListenerProxy
                                       implements IKeyReleasedListener
{
	...
	/**
	 * Creates a new instance of <code>IKeyReleasedListenerProxy</code>.
	 * 
	 * @param pHandler the handler
	 */
	public IKeyReleasedListenerProxy(InvocationHandler pHandler)
	{
		super(pHandler);
	}
