                                                        ...
                                                        implements IBean
{
                                           ...
                                           Map.Entry<String, Object>
    {
        ...
        {
        	Object oldValue = get(currentIndex);
        ...
        public boolean equals(Object pObject)
        {
            if (pObject instanceof Map.Entry)
            {
            	...
            	Object value = get(currentIndex);

                return propertyName.equals(entry.getKey()) && (value == null ? entry.getValue() == null : value.equals(entry.getValue()));
            }
        ...
        public int hashCode() 
        {
        	...
        	return propertyName.hashCode() ^ (value == null ? 0 : value.hashCode());
        }
