...
/**
 * The generic implementation of {@link IFocusListener}.
 * 
 * @author René Jahn
 */
public class IFocusListenerProxy extends AbstractListenerProxy
                                 implements IFocusListener
{
	 ...
	 */
	public IFocusListenerProxy(InvocationHandler pHandler)
	{
		super(pHandler);
	}
