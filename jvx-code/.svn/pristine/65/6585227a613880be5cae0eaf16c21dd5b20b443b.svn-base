...
/**
 * The client-side (GWT) widget that will render the component {@link com.sibvisions.rad.ui.vaadin.ext.ui.Switch} in the browser.
 * It is a copy of  {@link com.vaadin.client.ui.VCheckBox} widget but extends {@link com.google.gwt.user.client.ui.Switch}.
 * 
 * @author Stefan Wurm
 */
public class VSwitch extends com.google.gwt.user.client.ui.CheckBox 
                          implements Field,
                                     HandlesAriaInvalid, 
                                     HandlesAriaRequired
{
    ...
    /**
     * Creates a new instance of <code>VSwitch</code>.
     */
    public VSwitch() 
    {
        super("");
