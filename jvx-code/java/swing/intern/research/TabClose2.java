 ...
 * closes the tab.
 */
public class TabClose2 extends JTabbedPane implements MouseListener, MouseMotionListener 
{
   ...
   */
  public TabClose2(int horizontalTextPosition) {
    super();
