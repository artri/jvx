...
/**
 * The generic implementation of {@link IWindowClosedListener}.
 * 
 * @author René Jahn
 */
public class IWindowClosedListenerProxy extends AbstractListenerProxy
                                        implements IWindowClosedListener
{
	...
	/**
	 * Creates a new instance of <code>IWindowClosedListenerProxy</code>.
	 * 
	 * @param pHandler the handler
	 */
	public IWindowClosedListenerProxy(InvocationHandler pHandler)
	{
		super(pHandler);
	}
