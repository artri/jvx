...
/**
 * The <code>SessionCancelException</code> is a {@link SessionExpiredException} for 
...
public class SessionCancelException extends SessionExpiredException
{
	...
	/** 
	 * Constructs a new <code>SessionCancelException</code> with <code>null</code> as its
	...
	/** 
	 * Constructs a new <code>SessionCancelException</code> with the specified cause and a
     ...
     *               unknown.)
     */
	public SessionCancelException(Throwable pCause)
	{
		super(pCause);
	}
	
    /** 
     * Constructs a new <code>SessionCancelException</code> with the specified detail message.
     ...
     */
	public SessionCancelException(String pMessage)
	{
		super(pMessage);
	}
    ...
    /**
     * Constructs a new <code>SessionCancelException</code> with the specified detail message and
     ...
     *        unknown.)
     */
	public SessionCancelException(String pMessage, Throwable pCause)
	{
