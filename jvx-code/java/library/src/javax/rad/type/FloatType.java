...
/**
 * The <code>FloatType</code> is a platform independent definition of float.
 * 
...
public class FloatType extends AbstractNumberType<Float>
{
	...
	/**
	 * Constructs a new <code>FloatType</code>.
	 */
	public FloatType()
	{
	}
	...
	public Float valueOf(Object pObject)
	{
		...
		{
			return Internalize.intern(Float.valueOf(((Number)pObject).floatValue()));
		}
		else if (pObject instanceof CharSequence)
		{
			...
			{
				return Internalize.intern(Float.valueOf(sObject));
			}
		}
