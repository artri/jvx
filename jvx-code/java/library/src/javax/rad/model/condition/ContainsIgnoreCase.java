...
/**
 * The <code>ContainsIgnoreCase</code> condition is a <code>LikeIgnoreCase</code> condition with a leading and trailing *.
 * 
...
public class ContainsIgnoreCase extends LikeIgnoreCase
{
	...
	/**
	 * Creates a new instance of <code>ContainsIgnoreCase</code>.
	 */
	...
	/**
	 * Creates a new instance of <code>ContainsIgnoreCase</code> with a defined compare value.
	 * 
	 ...
	 */
	public ContainsIgnoreCase(String pColumnName, Object pValue) 
    {
    	super(pColumnName, pValue);
    }
    
	/**
	 * Creates a new instance of <code>ContainsIgnoreCase</code> with a defined compare value. It's
	 ...
	 */
    public ContainsIgnoreCase(String pColumnName, Object pValue, boolean pIgnoreNull) 
    {
    	super(pColumnName, pValue, pIgnoreNull);
    }
    
    /**
     * Constructs a new ContainsIgnoreCase Condition, with a column, the IDataRow to check
     ...
     */
    public ContainsIgnoreCase(IDataRow pDataRow, String pColumnName)
    {
     ...
     */
    public ContainsIgnoreCase(IDataRow pDataRow, String pColumnName, boolean pIgnoreNull)
    {
     ...
     * 			the column name to use for the compare operation
     */
    public ContainsIgnoreCase(IDataRow pDataRow, String pDataRowColumnName, String pColumnName)
    {
     ...
     * 			determines if null values should be ignored.
     */
    public ContainsIgnoreCase(IDataRow pDataRow, String pDataRowColumnName, String pColumnName, boolean pIgnoreNull)
    {
