...
/**
 * The <code>Greater</code> condition implements the comparison "&gt;" (greater) of values.
 * 
...
public class Greater extends CompareCondition
{
	...
	/**
	 * Creates a new instance of <code>Greater</code>.
	 */
	public Greater() 
    {
    }
	...
	/**
	 * Creates a new instance of <code>Greater</code> with a defined compare value.
	 * 
	 * @param pColumnName the column name for the value comparison
	 * @param pValue the value to compare 
	 */
	public Greater(String pColumnName, Object pValue) 
    {
    	super(pColumnName, pValue);
    }
    
	/**
	 * Creates a new instance of <code>Greater</code> with a defined compare value. It's
	 ...
	 */
    public Greater(String pColumnName, Object pValue, boolean pIgnoreNull) 
    {
    	super(pColumnName, pValue, pIgnoreNull);
    }
    
    /**
     * Constructs a new Greater Condition, with a column, the IDataRow to check
     ...
     */
    public Greater(IDataRow pDataRow, String pColumnName)
    {
     ...
     */
    public Greater(IDataRow pDataRow, String pColumnName, boolean pIgnoreNull)
    {
     ...
     * 			the column name to use for the compare operation
     */
    public Greater(IDataRow pDataRow, String pDataRowColumnName, String pColumnName)
    {
     ...
     * 			determines if null values should be ignored.
     */
    public Greater(IDataRow pDataRow, String pDataRowColumnName, String pColumnName, boolean pIgnoreNull)
    {
