...
public class VUpload extends SimplePanel {
    ...
    public VButton customSubmitButton;
    ...
    public VUpload() {
        ...
        setStyleName(getElement(), CLASSNAME + "-standard", true);
        setStyleName(getElement(), CLASSNAME + "-custom", false);
    }

    /**
     * Sets a custom submit button.
     * 
     * @param pCustomSubmitButton the custom submit button.
     */
    public void setCustomSubmitButton(VButton pCustomSubmitButton)
    {
        panel.remove(customSubmitButton == null ? submitButton : customSubmitButton);
        customSubmitButton = pCustomSubmitButton;
        setStyleName(getElement(), CLASSNAME + "-standard", customSubmitButton == null);
        setStyleName(getElement(), CLASSNAME + "-custom", customSubmitButton != null);
        ...
        {
            customSubmitButton.addClickHandler(new ClickHandler() {
                @Override
                public void onClick(ClickEvent event) {
                    if (isImmediateMode()) {
                        // fire click on upload (eg. focused button and hit space)
    ...
    private void setEnabledForSubmitButton(boolean enabled) {
        ...
        if (customSubmitButton != null)
        {
	        customSubmitButton.setEnabled(enabled);
    	    customSubmitButton.setStyleName(StyleConstants.DISABLED, !enabled);
	    }
    }
    ...
    private void rebuildPanel() {
        ...
        panel.add(fu);
        panel.add(customSubmitButton == null ? submitButton : customSubmitButton);
        if (isImmediateMode()) {
            fu.sinkEvents(Event.ONCHANGE);
        }
    }
    ...
    /** 
     * For internal use only. May be removed or replaced in the future. 
     * @param disable whehter to disable the title or not 
     */
