...
//                consoleLog("Split measure vertical splitter: " + splitPanel.getWidget().splitter.getOffsetHeight());
    ...
    protected Size measureSize(Widget pWidget, int pWidthHint)
    {
        ...
        if (element.hasAttribute("preferred-rows"))
        {
            ...
            widget.setHeight(preferredRows);
        }
        else
        {
        ...
        if (element.hasAttribute("preferred-columns"))
        {
            ...
            widget.setWidth(preferredColumns);
        }
        else
        {
            style.setProperty("width", "");
            if (pWidthHint > NO_SIZE && bWrapped 
                    && !String.valueOf(pWidthHint).equals(element.getAttribute("last-original-width"))) // size is like last preferred size. 
            {                                                                                           // we do not change the last preferred size until we are resize.
                ...
                String sOriginalWidth = "" + originalWidth;
                if (sOriginalWidth.equals(element.getAttribute("last-original-width")))
                {
        ...
        {
            widget.setHeight(previousHeight);
        }
