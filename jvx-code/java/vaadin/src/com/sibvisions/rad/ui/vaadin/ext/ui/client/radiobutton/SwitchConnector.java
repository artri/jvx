...
/**
 * The <code>SwitchConnector</code> class handles the communication between the server-side component Switch
 * and the client-side widget {@link VSwitch}.
 * 
 * It is a copy of {@link com.vaadin.client.ui.checkbox.CheckBoxConnector}. The only difference is the {@link #getWidget()}
 * method because it returns the {@link VSwitch}
 * 
 * @author Martin Handsteiner
 */
@Connect(com.sibvisions.rad.ui.vaadin.ext.ui.Switch.class)
public class SwitchConnector extends AbstractFieldConnector 
